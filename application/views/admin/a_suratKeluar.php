...
<div class="wrapper">
  ...
  $(document).ready( function () {
    ...
    function ubah_surat(noSurat)
    {
      ...
      $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="bidang"]').val(data.sk_bidang);
    ...
    function konfirmasi_hapus(noSurat)
    {
      ...
      $.ajax({
        ...
        success: function(data)
        {
            ...
            document.getElementById("konfirmasiPenerima").innerHTML = data.penerima;
    ...
    function save()
    {
      ...
      {
          url = "<?php echo site_url('admin/ubahSuratKeluar')?>";
      }
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form class="form-horizontal" form action="<?php echo base_url('controllerSurat/tambahSuratKeluar')?>" method="post" enctype="multipart/form-data" role="form">
            ...
            <div class="form-group">
              <label class="col-lg-3 col-sm-3 control-label">Penerima</label>
                <div class="col-lg-9">
                  <input class="form-control" type="text" name="penerimaTS" required>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label class="col-lg-3 col-sm-3 control-label">Yang Mengajukan</label>
                <div class="col-lg-9">
                  <select name="bidangTS" class="form-control">
                    <option value="TU">TU</option>
                    <option value="Penyusunan Program">Penyusunan Program</option>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-8">
              <label id="konfirmasiPenerima"></label>
            </div>
