...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('admin/dashboard'); ?>" class="logo">
      ...
      <span class="logo-lg"><b>Managing</b>Letter</span>
    </a>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a data-toggle="modal" data-target="#tambah-data" class="btn btn-success btn-lg" style="float:left; display: inline-block; font-size:20px; padding: 5px 10px 5px 10px;"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;Tambah Surat</a>
  ...
  $(document).ready( function () {
    ...
    function ubah_surat(noSurat)
    {
      ...
      $.ajax({
        ...
        success: function(data)
        {
          ...
          if(data.sm_proses != ""){
            var proses = data.sm_proses.split(",");
            $('#'+proses.join(', #')).prop('checked', true);
          }

          if(data.sm_bidang != ""){
            var bidang = data.sm_bidang.split(",");
            $('#'+bidang.join(', #')).prop('checked', true);
          }

            $('[name="id"]').val(data.id);
            $('[name="pengirim"]').val(data.pengirim);
            $('[name="tgl"]').val(data.tgl);
            $('[name="tglSurat"]').val(data.tglSurat);
    ...
    function konfirmasi_hapus(noSurat)
    {
      ...
      $.ajax({
        ...
        success: function(data)
        {
            ...
            document.getElementById("konfirmasitglSurat").innerHTML = data.tglSurat;
    ...
    function save()
    {
      ...
      {
          url = "<?php echo site_url('admin/ubahSuratMasuk')?>";
      }
  ...
  <div class="modal fade" id="tambah-data">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-titlee">Tambah Surat Masuk</h4>
        </div>
        <div class="modal-body">

          <form class="form-horizontal" form action="<?php echo base_url('controllerSurat/tambahSuratMasuk')?>" method="post" enctype="multipart/form-data" role="form">
            ...
            <div class="form-group">
              <label class="col-lg-3 col-sm-3 control-label">Tanggal Diterima</label>
                <div class="col-lg-9">
            ...
            <div class="form-group">
              <label class="col-lg-3 col-sm-3 control-label">Tanggal Surat</label>
                <div class="col-lg-9">
                  <input class="form-control" type="date" name="tglSuratTS" required>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label class="col-lg-3 col-sm-3 control-label">Posisi Surat</label>
                <div class="col-lg-9" style="margin-top:8px;">
                  <input type="checkbox" name="check_list[]" value="ae"> AE &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="check_list[]" value="tu"> TU &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="check_list[]" value="sekt"> SEKT &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="check_list[]" value="kaban"> KABAN &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="check_list[]" value="sekt2"> SEKT 2 &nbsp;&nbsp;&nbsp;
                </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 col-sm-3 control-label">Ditujukan Ke</label>
                <div class="col-lg-9" style="margin-top:8px;">
                  <input type="checkbox" name="check_list1[]" value="tu2"> TU 2 &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="check_list1[]" value="sungram"> Penyusunan Program &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="check_list1[]" value="keungan"> Keuangan &nbsp;&nbsp;&nbsp; <br>
                  <input type="checkbox" name="check_list1[]" value="pe"> Pembangunan Ekonomi &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="check_list1[]" value="kemas"> Kemasyarakatan &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="check_list1[]" value="sarpras"> Sarana Prasarana
                  <input type="checkbox" name="check_list1[]" value="pemer"> Pemerintahan &nbsp;&nbsp;&nbsp;
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="modal-body form">
          <form action="#" id="form" class="form-horizontal">
            ...
            <div class="form-group">
              <label class="col-lg-3 col-sm-3 control-label">Tanggal Surat</label>
                <div class="col-lg-9">
                  <input class="form-control" type="date" name="tglSurat" required>
                </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 col-sm-3 control-label">Nomor Surat</label>
            ...
            <div class="form-group">
              <label class="col-lg-3 col-sm-3 control-label">Posisi Surat</label>
                <div class="col-lg-9" style="margin-top:8px;">
                  <input type="checkbox" name="prosesEdit[]" id="ae" value="ae"> AE &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="prosesEdit[]" id="tu" value="tu"> TU &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="prosesEdit[]" id="sekt" value="sekt"> SEKT &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="prosesEdit[]" id="kaban" value="kaban"> KABAN &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="prosesEdit[]" id="sekt2" value="sekt2"> SEKT 2 &nbsp;&nbsp;&nbsp;
                </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 col-sm-3 control-label">Ditujukan Ke</label>
                <div class="col-lg-9" style="margin-top:8px;">
                  <input type="checkbox" name="prosesEdit[]" id="tu2" value="tu2"> TU 2 &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="bidangEdit[]" id="sungram" value="sungram"> Penyusunan Program &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="bidangEdit[]" id="keungan" value="keungan"> Keuangan &nbsp;&nbsp;&nbsp; <br>
                  <input type="checkbox" name="bidangEdit[]" id="pe" value="pe"> Pembangunan Ekonomi &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="bidangEdit[]" id="kemas" value="kemas"> Kemasyarakatan &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="bidangEdit[]" id="sarpras" value="sarpras"> Sarana Prasarana
                  <input type="checkbox" name="bidangEdit[]" id="pemer" value="pemer"> Pemerintahan &nbsp;&nbsp;&nbsp;
                </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 col-sm-3 control-label"></label>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h3 class="modal-titlee">Hapus surat ini ?</h3>
        </div>
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-8">
              <label id="konfirmasitglSurat" ></label>
            </div>
            <div class="col-md-1"></div>
            <div class="col-md-3">
              Nomor Surat
