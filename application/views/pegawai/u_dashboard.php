...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Dashboard
        <small>Halaman Depan Pengguna</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-lg-4 col-xs-12">
          ...
          <div class="small-box bg-purple">
            <div class="inner">
              ...
              <p>Surat untuk Baperwil</p>
            </div>
            <div class="icon">
              <i class="fa fa-envelope-o"></i>
            </div>
            <a href="<?php echo base_url('suratmasuk'); ?>" class="small-box-footer">Lihat Surat <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-xs-12">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              ...
              <p>Surat dari Baperwil</p>
            </div>
            <div class="icon">
              <i class="fa fa-send-o"></i>
            </div>
            <a href="<?php echo base_url('suratkeluar'); ?>" class="small-box-footer">Lihat Surat <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col-lg-4 col-xs-12">
          <!-- small box -->
